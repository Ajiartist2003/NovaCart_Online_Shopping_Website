<%@ Page Title="" Language="C#" MasterPageFile="~/html/main.master" AutoEventWireup="true" CodeBehind="payment.aspx.cs" Inherits="NovaCart.html.payment" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>NovaCart | Payment</title>
</asp:Content>
...
#gopi{
    ...
    <container style="background-image:url('../images/payment.jpg');background-size:cover;opacity:1;">
        <div class="payment-title">
            <h1 style="font-weight:bold; margin-bottom:80px; color:black; " >Payment Information</h1>
        </div>
    <div class="payment-wrapper" >
    <div class="container preload" style="margin-left:100px;" >
    ...
    <div class="form-container" style="margin-left:500px; margin-top :-290px;" >
        <div class="field-container">
            <label for="name" style="font-size:medium ; color:black; font-weight:600;">Name</label>
            <input id="name" maxlength="20" type="text">
        </div>
        <div class="field-container">
            <label for="cardnumber" style="font-size:medium ; color:black; font-weight:600;">Card Number</label>
            <input id="cardnumber" type="text" pattern="\d{4} \d{4} \d{4} \d{4}" inputmode="numeric" placeholder="1234 5678 9012 3456">
        ...
        <div class="field-container">
            <label for="expirationdate" style="font-size:medium; color:black; font-weight:600;">Expiration (mm/yy)</label>
            <input id="expirationdate" type="text" pattern="\d{2}/\d{2}" inputmode="numeric" placeholder="MM/YY">

        </div>
        <div class="field-container">
            <label for="securitycode" style="font-size:medium; color:black; font-weight:600;">Security Code</label>
            <input id="securitycode" type="password" pattern="\d{3,4}" inputmode="numeric" placeholder="123">

        </div>
        <div class="mt-4 pt-2 text-center">
    <asp:Button ID="Button1" runat="server" Text="Complete Payment" CssClass="btn btn-success btn-lg" OnClick="CompletePayment_Click" />
       </div>
    </div>
</div>
        </container>
    ...
    <script >
        ...
        window.onload = function () {
            ...
            securitycode_mask.on('accept', function () {
                var securityCode = securitycode_mask.value;
                if (securityCode.length == 0) {
                    document.getElementById('svgsecurity').innerHTML = '123';
                } else {
                    // Mask the security code as "***"
                    var maskedValue = '*'.repeat(securityCode.length);
                    document.getElementById('svgsecurity').innerHTML = maskedValue;
                }
            });
